...
(out of available idle ones) lock onto it. They rush outward, capture the spider and drag it to Spider Prison, before returning to ants nest.

Whenever any fresh leaf appears on the screen, a pair of small ants
(out of available idle ones) lock onto it. They rush outward, collect the leaf and drag it to Leaf Store, before returning to ant's nest.
